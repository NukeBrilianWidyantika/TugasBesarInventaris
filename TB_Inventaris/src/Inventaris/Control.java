...
public class Control {
    InventarisKampus ambil = new InventarisKampus();
    ...
    String analisis_kelistrikan() {
        if (call1.getPosisi_steker().equalsIgnoreCase("Dipojok Ruang dan Dekat Dosen")
...
//    }
    ...
    String analisis_internet() {
        if (call1.getSSID().equalsIgnoreCase("a")
